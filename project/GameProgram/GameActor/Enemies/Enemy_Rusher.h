...
private:
	...
	static constexpr float kChargeTimeMax_ = 1.0f;
	static constexpr float kStepBackSpeed_ = 5.0f;//後ろに下げる予備動作、この数値分を割る
	static constexpr float kScaleBack_ = 0.25f;

	static constexpr Vector3  kRushSpeed_ = { 0.0f,0.0f,0.25f };//突進の速さ
	
	static constexpr uint32_t kHp_ = 6;
	static constexpr Vector3 kEyeReach_ = { 15.0f,0.5f,0.5f };
