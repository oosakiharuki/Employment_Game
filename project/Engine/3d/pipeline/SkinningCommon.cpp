...
namespace EngineLayer {
	...
	void SkinningCommon::RootSignature() {
		...
		//skinning t0
		CreateTABLE(D3D12_SHADER_VISIBILITY_VERTEX, descriptorRange_);//[9] vs t0
		rootParameters_[9].DescriptorTable.NumDescriptorRanges = _countof(descriptorRange_);
	...
	void SkinningCommon::CreatePixelShader() {
		pixelShaderBlob = ShaderManager::GetInstance().CompileShader(L"resource/shaders/Object3d.PS.hlsl", L"ps_6_0");
