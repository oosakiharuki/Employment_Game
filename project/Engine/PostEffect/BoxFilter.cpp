...
void BoxFilter::Initialize(DirectXCommon* dxCommon) {
	dxCommon_ = dxCommon;
...
void BoxFilter::GraphicsPipeline() {
	...
	Microsoft::WRL::ComPtr<IDxcBlob> pixelShaderBlob = dxCommon_->CompileShader(L"resource/shaders/BoxFilter.PS.hlsl", L"ps_6_0");
