...
void GaussianFilter::Initialize(DirectXCommon* dxCommon) {
	dxCommon_ = dxCommon;
...
void GaussianFilter::GraphicsPipeline() {
	...
	Microsoft::WRL::ComPtr<IDxcBlob> pixelShaderBlob = dxCommon_->CompileShader(L"resource/shaders/GaussianFilter.PS.hlsl", L"ps_6_0");
