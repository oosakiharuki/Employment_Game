...
namespace EngineLayer {
	...
	void TextureManager::LoadTexture(const std::string& filePath) {
		...
		textureData.resource = D3D12CreateResourceManager::GetInstance().CreateTextureResource(textureData.metadata);
		Microsoft::WRL::ComPtr<ID3D12Resource> val = D3D12CreateResourceManager::GetInstance().UploadTextureData(textureData.resource, mipImages);
