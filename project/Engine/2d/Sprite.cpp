...
namespace EngineLayer {
	...
	void Sprite::InitVertexResource() {
		//Sprite
		vertexResource_ = D3D12CreateResourceManager::GetInstance().CreateBufferResource(sizeof(VertexData) * 4);
	...
	void Sprite::InitIndexData() {
		...
		//Index
		indexResource_ = D3D12CreateResourceManager::GetInstance().CreateBufferResource(sizeof(uint32_t) * 6);
	...
	void Sprite::InitTransformationMatrix() {
		//座標変換行列	
		transformationMatrixResource_ = D3D12CreateResourceManager::GetInstance().CreateBufferResource(sizeof(TransformationMatrix));
